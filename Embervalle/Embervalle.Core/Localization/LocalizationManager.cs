...
/// <summary>Descobre culturas com ficheiro .resx e aplica a cultura ativa do thread (UI e formato).</summary>
internal class LocalizationManager
{
    public const string DEFAULT_CULTURE_CODE = "en-EN";

    /// <summary>Enumera culturas com recursos .resx no assembly e inclui a cultura invariante.</summary>
    ...
    /// <summary>Define a cultura do thread corrente (formato e UI).</summary>
